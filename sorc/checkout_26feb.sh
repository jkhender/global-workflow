...
if [[ ! -d fv3gfs.fd ]] ; then
    ...
    if [ ${run_ccpp:-"NO"} = "NO" ]; then
        ...
        git clone --recursive -b gsl/develop https://github.com/NOAA-GSL/ufs-weather-model ufs-weather-model_26feb_99bd3e4 >> ${topdir}/checkout-fv3gfs.log
g 2>&1
        cd ufs-weather-model_26feb_99bd3e4
        git checkout 99bd3e44ae19aec9b5bf040e99ce3d16ab91e429
    fi
    git submodule update --init --recursive
    cd ${topdir}
    ln -fs ufs-weather-model_26feb_99bd3e4 fv3gfs.fd 
