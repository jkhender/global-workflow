...
if case == 'global':
    ...
    INFILE1 = 'INPUT/oro_data.tile{nt}.nc'
else:
    raise Exception("Case 'nested' not implemented/tested.")
...
while nt <= LAST:
    ...
    if case == 'global':
        ...
        tiles[nt]['lat'] = f1.variables['geolat'][:]
        tiles[nt]['lon'] = f1.variables['geolon'][:]
    f1.close()
    nt = nt+1
if case == 'global':
