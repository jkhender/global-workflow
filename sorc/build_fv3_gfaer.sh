...
if [ ${RUN_CCPP:-${1:-"NO"}} = "NO" ]; then
 ...
 ./compile.sh "$target" "APP=ATM 32BIT=Y SUITES=FV3_GFS_v16,FV3_GSD_noah,FV3_GSD_v0,FV3_GFS_v16_thompson,FV3_GFS_v16_gf" 2 YES NO
# ./compile.sh "$target" "APP=ATM 32BIT=Y SUITES=FV3_GFS_v16,FV3_GSD_noah,FV3_GSD_v0,FV3_GFS_v16_thompson,FV3_GFS_v16_gf,FV3_GFS_v16_mynn" 2 YES NO
 mkdir -p ../NEMS/exe
 mv -f fv3_2.exe ../NEMS/exe/global_fv3gfs_gfaer.x
fi
