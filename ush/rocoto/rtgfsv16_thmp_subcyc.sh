USER=rtfim
GITDIR=/home/rtfim/GFSv16_HFIP/                     ## where your git checkout is located
...
PSLOT=rt_gfsv16_thmp
IDATE=2021051700
EDATE=2021051700
RESDET=768               ## 96 192 384 768

ln -fs ${GITDIR}/parm/config/config.base.emc.dyn_jet_thmp ${GITDIR}/parm/config/config.base.emc.dyn
ln -fs ${GITDIR}/parm/config/config.base.emc.dyn_jet_thmp ${GITDIR}/parm/config/config.base
ln -fs ${GITDIR}/parm/config/config.postsnd_jet ${GITDIR}/parm/config/config.postsnd

### gfs_cyc 1  00Z only;  gfs_cyc 2  00Z and 12Z

./setup_expt_fcstonly_rtgsd.py --pslot $PSLOT  \
