...
Create COMROT experiment directory structure'''
    ...
    if machine == 'WCOSS_DELL_P3':
      ...
      stmp = '/lfs4/BMC/gsd-fv3-dev/rtruns/GFSv16_HFIP/FV3GFSrun/'
      ptmp = '/lfs4/BMC/gsd-fv3-dev/rtruns/GFSv16_HFIP/FV3GFSrun/'
      #JKHstmp = '/lfs4/BMC/gsd-fv3-dev/${USER}/scratch/${PSLOT}/FV3GFSrun/$USER'
      #JKHptmp = '/lfs4/BMC/gsd-fv3-dev/${USER}/scratch/${PSLOT}/FV3GFSrun/$USER'
      noscrub = '$HOMEDIR'
      account = 'gsd-fv3-dev'
      queue = 'batch'
      queue_service = 'service'
