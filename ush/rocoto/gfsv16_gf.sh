...
ln -fs ${GITDIR}/parm/config/config.base.emc.dyn_hera_gf ${GITDIR}/parm/config/config.base.emc.dyn
ln -fs ${GITDIR}/parm/config/config.base.emc.dyn_hera_gf ${GITDIR}/parm/config/config.base
